...
export default function SuccessPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6" style={{ background: theme.bg }}>
      ...
      >
        <div
          className="mx-auto mb-6 flex h-14 w-14 items-center justify-center rounded-2xl text-xl text-white shadow-lg shadow-pink-500/20"
        ...
        <p className="mt-3 text-sm leading-relaxed text-white/50">
          Your Instagram report is being generated. Check your inbox in the next{" "}
          <span className="font-medium text-white/80">5 minutes</span>.
        </p>
        <Link
          href="/"
